...
def parse_arguments():
  ...
  parser.add_argument("--content_dir", type=str, default = r"D:\\PROJECTS\\Neural_Style_Transfer\\content_data", help="Location of content dataset")

  parser.add_argument("--style_dir", type=str, default = r"D:\\PROJECTS\\Neural_Style_Transfer\\style_data", help="Location of style dataset")

  parser.add_argument("--vgg", type=str, default = r"D:\\PROJECTS\\Neural_Style_Transfer\\vgg_normalised.pth", help="Location of pretrained VGG")

  parser.add_argument("--experiment", type=str, default = "Name of experiment", help="Experiment 1")
...
def main():
  ...
  # Save argument values in text file
  ...
  print("No of batches in content dataset:",len(content_dataloader))
  print("No of batches in style dataset:",len(style_dataloader))
  ...
  print("Training....")
  # In training loop e need to calculate loss
  ...
  for epoch in range(args.epochs):
    ...
    for content_batch , style_batch in progress_bar:
      ...
      # so we have moved them to gpu and now well perform next operations

      c_feats = encoder(content_batch)
      s_feats = encoder(style_batch)

      # print("len c_feats", len(c_feats))
      # print("len s_feats", len(s_feats))
      ...
      # we need to calculate 3 losses - final loss, style and content
      # content loss is between g_features(g_feats)last layer and t
